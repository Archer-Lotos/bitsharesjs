...
export var asset_update_bitasset_operation_fee_parameters = new Serializer("asset_update_bitasset_operation_fee_parameters", {
  fee: uint64
});
export var asset_update_feed_producers_operation_fee_parameters = new Serializer("asset_update_feed_producers_operation_fee_parameters", {
  fee: uint64
});
...
export var asset_fund_fee_pool_operation_fee_parameters = new Serializer("asset_fund_fee_pool_operation_fee_parameters", {
  fee: uint64
});
export var asset_settle_operation_fee_parameters = new Serializer("asset_settle_operation_fee_parameters", {
  fee: uint64
});
export var asset_global_settle_operation_fee_parameters = new Serializer("asset_global_settle_operation_fee_parameters", {
  fee: uint64
});
export var asset_publish_feed_operation_fee_parameters = new Serializer("asset_publish_feed_operation_fee_parameters", {
  fee: uint64
});
...
export var custom_authority_update_operation_fee_parameters = new Serializer("custom_authority_update_operation_fee_parameters", {
  basic_fee: uint64,
  price_per_byte: uint32
});
export var custom_authority_delete_operation_fee_parameters = new Serializer("custom_authority_delete_operation_fee_parameters", {
  fee: uint64
});
export var ticket_create_operation_fee_parameters = new Serializer("ticket_create_operation_fee_parameters", {
  fee: uint64
});
...
export var op_wrapper = new Serializer("op_wrapper", {
  op: operation
});
...
export var custom_authority_create = new Serializer("custom_authority_create", {
  fee: asset,
  account: protocol_id_type("account"),
  enabled: bool,
...
export var custom_authority_update = new Serializer("custom_authority_update", {
  fee: asset,
  account: protocol_id_type("account"),
...
export var custom_authority_delete = new Serializer("custom_authority_delete", {
  fee: asset,
  account: protocol_id_type("account"),
  authority_to_delete: protocol_id_type("object"),
  extensions: set(future_extensions)
});
export var ticket_create = new Serializer("ticket_create", {
  fee: asset,
  account: protocol_id_type("account"),
...
export var ticket_update = new Serializer("ticket_update", {
  fee: asset,
