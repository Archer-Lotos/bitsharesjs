...
var Aes = /*#__PURE__*/function () {
  ...
  */
  ...
  _proto._encrypt_word_array = function _encrypt_word_array(plaintext) {
    ...
    var cipher = AES.encrypt(plaintext, this.key, {
      iv: this.iv
    });
  ...
  */
  ...
  _proto.decrypt = function decrypt(ciphertext) {
    ...
    assert(ciphertext, "Missing cipher text"); // hex is the only common format
  ...
  */
  ...
  _proto.decryptHex = function decryptHex(cipher) {
    assert(cipher, "Missing cipher text"); // Convert data into word arrays (used by Crypto)
